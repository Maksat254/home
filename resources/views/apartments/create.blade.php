...
<div class="container">
    <form action="{{ route('apartments.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="rooms" class="form-control" id="floor_id">
        </div>

        <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label">floor</label>
            <input type="text" name="floor" class="form-control" id="exampleFormControlInput1">
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="home_id" class="form-control" id="exampleFormControlInput1">
