...
<div class="container">
    <form action="{{ route('sales.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="home_id" class="form-control" id="floor_id">
        </div>

        <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label">apartment_id</label>
            <input type="text" name="apartment_id" class="form-control" id="exampleFormControlInput1">
        </div>

        <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label">customer_id</label>
            <input type="text" name="customer_id" class="form-control" id="exampleFormControlInput1">
        </div>
